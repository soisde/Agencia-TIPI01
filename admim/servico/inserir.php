...
<input type="text" id="titulo" name="tituloServico" required>

        <label for="texto">Texto:</label>
<textarea id="texto" name="descricaoServico" required></textarea>

        <label>Status:</label>
<input type="checkbox" id="ativo" name="statusServico" value="1" checked>
<label class="checkbox-label" for="ativo">Sim</label>

<label for="link">link:</label>
<input type="link" id="link" name="urlServico" required>
